...
class WalkingState:
    ...
    def draw(boy):
        ...
        boy.font.draw(sx - 40, sy + 40, '(%d, %d), %d' % (boy.x, boy.y, boy.ball_num), (255, 255, 0))
...
class Boy:
    ...
    def get_bb(self):
        return self.x - server.background.window_left - 25, self.y - server.background.window_bottom - 50, self.x - server.background.window_left + 25, self.y - server.background.window_bottom + 50
